...
internal sealed class OrderedDamageTypesTravelerSkillEffect : TravelerSkillEffect
{
    private readonly IReadOnlyList<string> _damageTypes;

    public OrderedDamageTypesTravelerSkillEffect(IReadOnlyList<string> damageTypes)
    {
