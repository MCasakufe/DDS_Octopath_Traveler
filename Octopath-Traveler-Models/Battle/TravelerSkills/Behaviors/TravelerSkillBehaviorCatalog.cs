...
internal sealed class TravelerSkillBehaviorCatalog
{
    ...
    private static readonly string[] BalogarsBladeDamageTypes =
        ["Fire", "Ice", "Lightning", "Wind", "Light", "Dark"];
    private static readonly string[] WinnehildsBattleCryDamageTypes =
    ...
    private static readonly TravelerSkillTargetSelector OneBeastTargetSelector =
        new OneBeastTravelerSkillTargetSelector();
    ...
    private readonly IReadOnlyList<TravelerSkillBehavior> _skillBehaviors;

    public TravelerSkillBehaviorCatalog()
    {
        _skillBehaviors = BuildSkillBehaviors();
    }

    public IReadOnlyList<TravelerSkillResult> ApplyBehavior(TravelerSkillExecutionContext executionContext)
    {
        foreach (TravelerSkillBehavior skillBehavior in _skillBehaviors)
        {
            if (skillBehavior.CanHandleSkill(executionContext.SkillName))
                return skillBehavior.Apply(executionContext);
        }
